...
// Copyright (c) 2009-2012 The Billiecoin Core developers
...
CMD_REGEX= "perl -pi -e 's/(20\d\d)(?:-20\d\d)? The Billiecoin/$1-%s The Billiecoin/' %s"
REGEX_CURRENT= re.compile("%s The Billiecoin" % year)
