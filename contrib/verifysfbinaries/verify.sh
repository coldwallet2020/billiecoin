...
###   This script attempts to download the signature file SHA256SUMS.asc from billiecoin.green
...
WORKINGDIR="/tmp/billiecoin"
TMPFILE="hashes.tmp"

SIGNATUREFILENAME="SHA256SUMS.asc"
RCSUBDIR="test/"
BASEDIR="https://billiecoin.green/bin/"
...
if [ $RET -ne 0 ]; then
   if [ $RET -eq 1 ]; then
      ...
      echo "gpg error. Do you have the Billiecoin Core binary release signing key installed?"
   fi
