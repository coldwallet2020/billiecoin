...
bool CZMQPublishRawBilliecoinNotifier::NotifyBilliecoinUpdate(const char * value, const char * topic)
{
	LogPrint("zmq", "zmq: Publish raw billiecoin payload for topic %s: %s\n", topic, value);
