 ...
 */
#ifndef BILLIECOIN_UTIL_H
#define BILLIECOIN_UTIL_H
...
extern const char * const BILLIECOIN_CONF_FILENAME;
extern const char * const BILLIECOIN_PID_FILENAME;
...
{
    std::string s = strprintf("billiecoin-%s", name);
