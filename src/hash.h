...
#ifndef BILLIECOIN_HASH_H
#define BILLIECOIN_HASH_H
...
/* ----------- Billiecoin Hash ------------------------------------------------- */
/** A hasher class for Billiecoin's 256-bit hash (double SHA-256). */
class CHash256 {
private:
    CSHA256 sha;
public:
...
/** A hasher class for Billiecoin's 160-bit hash (SHA-256 + RIPEMD-160). */
class CHash160 {
private:
    CSHA256 sha;
public:
