...
#ifndef BILLIECOIN_QT_BILLIECOINUNITS_H
#define BILLIECOIN_QT_BILLIECOINUNITS_H
...
/** Billiecoin unit definitions. Encapsulates parsing and formatting
   and serves as list model for drop-down selection boxes.
*/
class BilliecoinUnits: public QAbstractListModel
{
    Q_OBJECT

public:
    explicit BilliecoinUnits(QObject *parent);

    /** Billiecoin units.
      @note Source: https://en.billiecoin.it/wiki/Units . Please add only sensible ones
     */
    enum Unit
    {
        BILCO,
    ...
    //! Number of Finneas (1e-8) per unit
    ...
    //! Return maximum number of base units (Finneas)
    static CAmount maxMoney();

private:
    QList<BilliecoinUnits::Unit> unitlist;
};
typedef BilliecoinUnits::Unit BilliecoinUnit;

#endif // BILLIECOIN_QT_BILLIECOINUNITS_H
