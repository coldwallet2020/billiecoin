    ...
    mapper(0)
{
    ...
    /* Theme selector */
    ui->theme->addItem(QString("BILCO-light"), QVariant("light"));
    
    /* Language selector */
    QDir translations(":translations");

    ui->billiecoinAtStartup->setToolTip(ui->billiecoinAtStartup->toolTip().arg(tr(PACKAGE_NAME)));
    ui->billiecoinAtStartup->setText(ui->billiecoinAtStartup->text().arg(tr(PACKAGE_NAME)));
    ...
    ui->unit->setModel(new BilliecoinUnits(this));
...
{
    /* Main */
    mapper->addMapping(ui->billiecoinAtStartup, OptionsModel::StartAtStartup);
