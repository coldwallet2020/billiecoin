...
#ifndef BILLIECOIN_QT_OPTIONSMODEL_H
#define BILLIECOIN_QT_OPTIONSMODEL_H
...
/** Interface from Qt to configuration data structure for Billiecoin client.
...
public:
    ...
    enum OptionID {
        ...
        ProxyIPTor,             // QString
        ProxyPortTor,           // int
        DisplayUnit,            // BilliecoinUnits::Unit
...
#endif // BILLIECOIN_QT_OPTIONSMODEL_H
