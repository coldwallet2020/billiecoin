...
public:
    TxViewDelegate(const PlatformStyle *_platformStyle, QObject *parent=nullptr):
        QAbstractItemDelegate(), unit(BilliecoinUnits::BILCO),
                      ...
                      const QModelIndex &index ) const
    {
        ...
        painter->setPen(foreground);
        QString amountText = BilliecoinUnits::floorWithUnit(unit, amount, true, BilliecoinUnits::separatorAlways);
        if(!confirmed)
        {
...
void OverviewPage::setBalance(const CAmount& balance, const CAmount& unconfirmedBalance, const CAmount& immatureBalance, const CAmount& anonymizedBalance, const CAmount& watchOnlyBalance, const CAmount& watchUnconfBalance, const CAmount& watchImmatureBalance)
{
    ...
    ui->labelBalance->setText(BilliecoinUnits::floorHtmlWithUnit(nDisplayUnit, balance, false, BilliecoinUnits::separatorAlways));
    ui->labelUnconfirmed->setText(BilliecoinUnits::floorHtmlWithUnit(nDisplayUnit, unconfirmedBalance, false, BilliecoinUnits::separatorAlways));
    ui->labelImmature->setText(BilliecoinUnits::floorHtmlWithUnit(nDisplayUnit, immatureBalance, false, BilliecoinUnits::separatorAlways));
    ui->labelAnonymized->setText(BilliecoinUnits::floorHtmlWithUnit(nDisplayUnit, anonymizedBalance, false, BilliecoinUnits::separatorAlways));
    ui->labelTotal->setText(BilliecoinUnits::floorHtmlWithUnit(nDisplayUnit, balance + unconfirmedBalance + immatureBalance, false, BilliecoinUnits::separatorAlways));
    ui->labelWatchAvailable->setText(BilliecoinUnits::floorHtmlWithUnit(nDisplayUnit, watchOnlyBalance, false, BilliecoinUnits::separatorAlways));
    ui->labelWatchPending->setText(BilliecoinUnits::floorHtmlWithUnit(nDisplayUnit, watchUnconfBalance, false, BilliecoinUnits::separatorAlways));
    ui->labelWatchImmature->setText(BilliecoinUnits::floorHtmlWithUnit(nDisplayUnit, watchImmatureBalance, false, BilliecoinUnits::separatorAlways));
    ui->labelWatchTotal->setText(BilliecoinUnits::floorHtmlWithUnit(nDisplayUnit, watchOnlyBalance + watchUnconfBalance + watchImmatureBalance, false, BilliecoinUnits::separatorAlways));
...
void OverviewPage::setWalletModel(WalletModel *model)
{
    ...
    {
        // update the display unit, to not use the default ("BILCO")
        updateDisplayUnit();
...
void OverviewPage::updatePrivateSendProgress()
{
    ...
    QString strPrivateSendAmount = BilliecoinUnits::formatHtmlWithUnit(nDisplayUnit, privateSendClient.nPrivateSendAmount * COIN, false, BilliecoinUnits::separatorAlways);
    ...
    if(currentBalance == 0)
    {
        ...
        strPrivateSendAmount = strPrivateSendAmount.remove(strPrivateSendAmount.indexOf("."), BilliecoinUnits::decimals(nDisplayUnit) + 1);
    ...
    if(nMaxToAnonymize >= privateSendClient.nPrivateSendAmount * COIN) {
        ...
        QString strMaxToAnonymize = BilliecoinUnits::formatHtmlWithUnit(nDisplayUnit, nMaxToAnonymize, false, BilliecoinUnits::separatorAlways);
        ui->labelAmountRounds->setToolTip(tr("Not enough compatible inputs to anonymize <span style='color:red;'>%1</span>,<br>"
                                             "will anonymize <span style='color:red;'>%2</span> instead")
                                          .arg(strPrivateSendAmount)
                                          .arg(strMaxToAnonymize));
        strMaxToAnonymize = strMaxToAnonymize.remove(strMaxToAnonymize.indexOf("."), BilliecoinUnits::decimals(nDisplayUnit) + 1);
        strAmountAndRounds = "<span style='color:red;'>" +
                QString(BilliecoinUnits::factor(nDisplayUnit) == 1 ? "" : "~") + strMaxToAnonymize +
...
void OverviewPage::togglePrivateSend(){
    ...
    if(!privateSendClient.fEnablePrivateSend){
        ...
        if(currentBalance < nMinAmount){
            QString strMinAmount(BilliecoinUnits::formatWithUnit(nDisplayUnit, nMinAmount));
            QMessageBox::warning(this, tr("PrivateSend"),
