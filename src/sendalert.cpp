...
2. run billiecoind with -printalert or -sendalert like this:
   /path/to/billiecoind -printalert
...
void ThreadSendAlert(CConnman& connman)
{
    ...
    alert.strComment    = "";
    alert.strStatusBar  = "URGENT: Upgrade required: see https://www.billiecoin.green";

    // Set specific client version/versions here. If setSubVer is empty, no filtering on subver is done:
    // alert.setSubVer.insert(std::string("/Billiecoin Core:0.12.0.58/"));
