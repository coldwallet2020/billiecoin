...
#ifndef BILLIECOIN_RPCSERVER_H
#define BILLIECOIN_RPCSERVER_H
...
/**
 * Billiecoin RPC command dispatcher.
 */
class CRPCTable
{
private:
...
extern UniValue prunebilliecoinservices(const JSONRPCRequest& request);
...
extern UniValue billiecoinlistreceivedbyaddress(const JSONRPCRequest& request);
extern UniValue sendrawtransaction(const JSONRPCRequest& request);
extern UniValue createrawtransaction(const JSONRPCRequest& request);
extern UniValue billiecoinsendrawtransaction(const JSONRPCRequest& request);
extern UniValue billiecoindecoderawtransaction(const JSONRPCRequest& request);
