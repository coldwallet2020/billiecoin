...
UniValue stop(const JSONRPCRequest& jsonRequest)
{
    ...
    if (jsonRequest.fHelp || jsonRequest.params.size() > 1)
        throw std::runtime_error(
            "stop\n"
            "\nStop Billiecoin Core server.");
    // Event loop will exit after current HTTP requests have been handled, so
    // this reply will get back to the client.
    StartShutdown();
    return "Billiecoin Core server stopping";
}
...
{ //  category              name                      actor (function)         okSafe argNames
  ...
  // BILLIECOIN rpc functions
	...
	{ "wallet", "billiecoinsendrawtransaction",		 &billiecoinsendrawtransaction,	false ,  {}},
	{ "wallet", "billiecoindecoderawtransaction",		 &billiecoindecoderawtransaction,	false ,  {}},
	{ "wallet", "billiecoinlistreceivedbyaddress",		 &billiecoinlistreceivedbyaddress,	false ,  {}},
	{ "wallet", "prunebilliecoinservices",          &prunebilliecoinservices,          false ,  {}},
...
{
    return "> billiecoin-cli " + methodname + " " + args + "\n";
}
