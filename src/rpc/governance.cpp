...
UniValue gobject(const JSONRPCRequest& request)
{
    ...
    if (request.fHelp  ||
        ...
        throw std::runtime_error(
                ...
                "  vote-conf          - Vote on a governance object by masternode configured in billiecoin.conf\n"
    ...
    */
    ...
    if(strCommand == "vote-conf")
    {
        ...
        if(!fMnFound) {
            ...
            resultsObj.push_back(Pair("billiecoin.conf", statusObj));
...
{ //  category              name                      actor (function)         okSafe argNames
  //  --------------------- ------------------------  -----------------------  ------ ----------
    /* Billiecoin features */
    { "billiecoin",               "getgovernanceinfo",      &getgovernanceinfo,      true,  {} },
    { "billiecoin",               "getsuperblockbudget",    &getsuperblockbudget,    true,  {"index"} },
    { "billiecoin",               "gobject",                &gobject,                true,  {} },
    { "billiecoin",               "voteraw",                &voteraw,                true,  {} },
