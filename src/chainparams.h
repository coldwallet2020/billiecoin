...
#ifndef BILLIECOIN_CHAINPARAMS_H
#define BILLIECOIN_CHAINPARAMS_H
 ...
 * Billiecoin system. There are three: the main network on which people trade goods
...
#endif // BILLIECOIN_CHAINPARAMS_H
