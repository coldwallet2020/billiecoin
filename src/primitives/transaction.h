...
#ifndef BILLIECOIN_PRIMITIVES_TRANSACTION_H
#define BILLIECOIN_PRIMITIVES_TRANSACTION_H
...
public:
    ...
    {
        // "Dust" is defined in terms of CTransaction::minRelayTxFee, which has units finneas-per-kilobyte.
        // If you'd pay more than 1/3 in fees to spend something, then we consider it dust.
        // A typical spendable txout is 34 bytes big, and will need a CTxIn of at least 148 bytes to spend
        // i.e. total is 148 + 32 = 182 bytes. Default -minrelaytxfee is 1000 finneas per kB
        // and that means that fee per spendable txout is 182 * 1000 / 1000 = 182 finneas.
        // So dust is a spendable txout less than 546 * minRelayTxFee / 1000 (in finneas)
        // i.e. 182 * 3 = 546 finneas with default -minrelaytxfee = minRelayTxFee = 1000 finneas per kB.
 ...
 * https://github.com/billiecoin/bips/blob/master/bip-0069.mediawiki
 */
...
#endif // BILLIECOIN_PRIMITIVES_TRANSACTION_H
