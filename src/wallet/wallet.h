...
#ifndef BILLIECOIN_WALLET_WALLET_H
#define BILLIECOIN_WALLET_WALLET_H
...
public:
     ...
     * on this billiecoin node, and set to 0 for transactions that were created
...
public:
     ...
     */
    void AvailableCoins(std::vector<COutput>& vCoins, bool fOnlyConfirmed=true, const CCoinControl *coinControl = NULL, bool fIncludeZeroValue=false, AvailableCoinsType nCoinType=ALL_COINS, bool fUseInstantSend = false, bool fIncludeBilliecoinAliasBalances = false, bool fIncludeBilliecoinAliasOutputs = false) const;
...
#endif // BILLIECOIN_WALLET_WALLET_H
