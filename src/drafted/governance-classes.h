 ...
 *
 *   // network
 *   CBilliecoinNetwork lvl, network-type, network-status, network-error, milestone-status*
...
private:
    ...
    // Current OBJECT STATUS (see http://govman.billiecoin.green/index.php/Documentation_:_Status_Field)
    int nStatusID;
...
// // root node
class CBilliecoinNetwork : public CGovernanceObject
{
private:
    std::string strName;
    std::string strURL;
...
public:
    CBilliecoinNetwork(UniValue objIn)
    {
...
// // can be under: BilliecoinNetwork
// //   -- signature requirements : Key1(User)
// class CBilliecoinNetworkVariable : public CGovernanceObject
// {
// private:
...
//     //     return (IsType() == BilliecoinNetwork);
//     // }
