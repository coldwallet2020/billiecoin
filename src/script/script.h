...
#ifndef BILLIECOIN_SCRIPT_SCRIPT_H
#define BILLIECOIN_SCRIPT_SCRIPT_H
...
enum opcodetype
{
	...
	// billiecoin extended reserved 
	OP_BILLIECOIN_ALIAS = 0x01,
	OP_BILLIECOIN_CERT = 0x02,
	OP_BILLIECOIN_ESCROW = 0x03,
	OP_BILLIECOIN_OFFER = 0x04,
	OP_BILLIECOIN_ASSET = 0x05,
	OP_BILLIECOIN_ASSET_ALLOCATION = 0x06,
    OP_FALSE = OP_0,
    OP_PUSHDATA1 = 0x4c,
    OP_PUSHDATA2 = 0x4d,
    OP_PUSHDATA4 = 0x4e,
...
public:
    ...
    /**
     * Pre-version-0.6, Billiecoin always counted CHECKMULTISIGs
...
#endif // BILLIECOIN_SCRIPT_SCRIPT_H
