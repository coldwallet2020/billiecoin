...
#ifndef BILLIECOIN_TEST_SCRIPTNUM10_H
#define BILLIECOIN_TEST_SCRIPTNUM10_H
...
{
/**
 * The ScriptNum implementation from Billiecoin Core 0.10.0, for cross-comparison.
 */
public:
...
#endif // BILLIECOIN_TEST_BIGNUM_H
