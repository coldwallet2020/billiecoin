...
BOOST_AUTO_TEST_CASE(rpc_wallet)
{
	...
	UniValue r;
	CPubKey demoPubkey;
	CBilliecoinAddress demoAddress;
	UniValue retValue;
	string strAccount = "walletDemoAccount";
	CBilliecoinAddress setaccountDemoAddress;
	{
		LOCK(pwalletMain->cs_wallet);

		demoPubkey = pwalletMain->GenerateNewKey(0, false);
		demoAddress = CBilliecoinAddress(CTxDestination(demoPubkey.GetID()));
		...
		setaccountDemoAddress = CBilliecoinAddress(CTxDestination(setaccountDemoPubkey.GetID()));
	}
	/*********************************
	* 			setaccount
	*********************************/
	...
	*********************************/
	...
	BOOST_CHECK(CBilliecoinAddress(retValue.get_str()).Get() == demoAddress.Get());
	...
	*********************************/
	...
	BOOST_CHECK(CBilliecoinAddress(arr[0].get_str()).Get() == demoAddress.Get());
