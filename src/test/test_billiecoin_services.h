...
#ifndef BILLIECOIN_TEST_TEST_BILLIECOIN_SERVICES_H
#define BILLIECOIN_TEST_TEST_BILLIECOIN_SERVICES_H
...
/** Testing billiecoin services setup that configures a complete environment with 3 nodes.
 */
...
const string OfferNew(const string& node, const string& aliasname, const string& category, const string& title, const string& qty, const string& price, const string& description, const string& currency, const string& certguid="''", const string& paymentoptions="BILCO",  const string& offerType = "BUYNOW", const string& auction_expires = "0", const string& auction_reserve = "0", const string& auction_require_witness = "false", const string &auction_deposit = "0", const string& witness="''");
...
struct BilliecoinTestingSetup {
    BilliecoinTestingSetup();
    ~BilliecoinTestingSetup();
};
struct BasicBilliecoinTestingSetup {
    BasicBilliecoinTestingSetup();
    ~BasicBilliecoinTestingSetup();
};
struct BilliecoinMainNetSetup {
	BilliecoinMainNetSetup();
	~BilliecoinMainNetSetup();
};
#endif
