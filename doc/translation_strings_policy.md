...
This document provides guidelines for internationalization of the Billiecoin Core software.
...
This can be checked by executing `make translate` in the `src` directory, then verifying that `billiecoin_en.ts` remains unchanged.
