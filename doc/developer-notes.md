...
Billiecoin Core is a multithreaded application, and deadlocks or other multithreading bugs
...
- ThreadSocketHandler : Sends/Receives data from peers on port 5369.
...
- BilliecoinMiner : Generates coins (if wallet is enabled).
...
However, in open source software such as Billiecoin Core, where everyone uses
...
pay attention to for reviewers of Billiecoin Core code.

General Billiecoin Core
----------------------
...
- For `strprintf`, `LogPrint`, `LogPrintf` formatting characters don't need size specifiers
  ...
  - *Rationale*: Billiecoin Core uses tinyformat, which is type safe. Leave them out to avoid confusion
