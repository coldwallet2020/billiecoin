...
This mechanism has been integrated into Bitcore-Node-Billiecoin which allows for notification to be broadcast through Insight API in one of two ways:
* WebSocket: [https://github.com/billiecoin/insight-api-billiecoin#web-socket-api](https://github.com/billiecoin/insight-api-billiecoin#web-socket-api) 
* API: [https://github.com/billiecoin/insight-api-billiecoin#instantsend-transactions](https://github.com/billiecoin/insight-api-billiecoin#instantsend-transactions) 
