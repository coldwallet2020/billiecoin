...
class AddressIndexTest(BilliecoinTestFramework):
    ...
    def run_test(self):
        ...
        assert_equal(utxos[0]["finneas"], change_amount)
        ...
        assert_equal(utxos2[0]["finneas"], amount)
