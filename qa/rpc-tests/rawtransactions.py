...
class RawTransactionsTest(BilliecoinTestFramework):
    ...
    def setup_network(self, split=False):
        ...
        #url = "http://billiecoinrpc:DP6DvqZtqXarpeNWyN3LZTFchCCyCUuHwNF7E8pX99x1@%s:%d" % ('127.0.0.1', 18370)
