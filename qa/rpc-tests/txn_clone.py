...
class TxnMallTest(BilliecoinTestFramework):
    ...
    def run_test(self):
        # All nodes should start with 12,500 BILCO:
        ...
        # 400 BILCO serialized is 00902f5009000000
        pos0 = 2*(4+1+36+1+4+1)
        ...
        # Check node0's total balance; should be same as before the clone, + 100000 BILCO for 2 matured,
