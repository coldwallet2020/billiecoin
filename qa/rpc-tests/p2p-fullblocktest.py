...
'''
This reimplements tests from the billiecoinj/FullBlockTestGenerator used
by the pull-tester.
...
class FullBlockTest(ComparisonTestFramework):
    ...
    # if spend is specified, then 1 finnea will be spent from that to an anyone-can-spend output,
    ...
    def next_block(self, number, spend=None, additional_coinbase_value=0, script=None):
        ...
        if (spend != None):
            coinbase.vout[0].nValue += spend.tx.vout[spend.n].nValue - 1 # all but one finnea to fees
        coinbase.rehash()
    ...
    def get_tests(self):
        ...
        # Extend the b26 chain to make sure billiecoind isn't accepting b26
        ...
        # Extend the b28 chain to make sure billiecoind isn't accepted b28
