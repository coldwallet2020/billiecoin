...
This document describes the protocol extensions for all additional functionality build into the Billiecoin protocol. This doesn't include any of the Billiecoin protocol, which has been left intact in the Billiecoin project. For more information about the core protocol, please see https://en.billiecoin.it/w/index.php?title#Protocol_documentation&action#edit
...
Billiecoin Outpoint https://billiecoin.green/en/glossary/outpoint
...
Billiecoin Input https://billiecoin.green/en/glossary/input
...
Billiecoin Output https://billiecoin.green/en/glossary/output
...
Billiecoin Public Key https://billiecoin.green/en/glossary/public-key
...
| Field Size | Field Name | Data type | Description |
| ---------- | ----------- | --------- | -------- |
| 41 | vin | [CTxIn](#ctxin) | The unspent output which is holding 100000 BILCO
| # | addr | [CService](#cservice) | IPv4 address of the masternode
| 33-65 | pubKeyCollateralAddress | [CPubKey](#cpubkey) | CPubKey of the main 100000 BILCO unspent output
...
| 10004 | 5 | INSTANTSEND_MAX_VALUE | Controls the max value for an InstantSend transaction (currently 2000 billiecoin)
| 10007 | 8 | MASTERNODE_PAYMENT_ENFORCEMENT | Requires masternodes to be paid by miners when blocks are processed
| 10008 | 9 | SUPERBLOCKS_ENABLED | Superblocks are enabled (the 10% comes to fund the billiecoin treasury)
...
| Field Size | Field Name | Data type | Description |
| ---------- | ----------- | --------- | -------- |
| 41 | vin1 | [CTxIn](#ctxin) | The unspent output which is holding 100000 BILCO for masternode 1
| 41 | vin2 | [CTxIn](#ctxin) | The unspent output which is holding 100000 BILCO for masternode 2
