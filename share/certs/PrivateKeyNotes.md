...
unlocked to sign the Billiecoin-Qt.app bundle.
...
allowing somebody to distribute a Billiecoin-Qt.app or billiecoin-qt-setup.exe with a valid
...
that the billiecoin-qt.exe file inside the installer had not been tampered with.
